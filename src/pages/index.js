...
const IndexPage = () => (
	<Layout>
		...
		<div className="container">
			<div className="w-full prose text-lg max-w-none lg:w-7/12 mx-auto lg:px-8 text-cool-gray-700">
				<p>
				...
				<p>For this website I named portoby, the repository is here. You can use this freely, it uses Tailwindcss and Gatsbyjs technology. You only need to fork then change the profile, then you can deploy on netlify easily.</p>
			</div>
		</div>
	</Layout>
)
